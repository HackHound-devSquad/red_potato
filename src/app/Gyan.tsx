...
function Gyan() {
    return (
        <>
            ...
            <section className="flex gap-x-5 pr-14 h-full w-screen items-center  ">
                <div className="flex-1 rounded-2xl overflow-clip">
                    <Image src={fireburger} className="max-w-[500px] rounded-2xl overflow-clip  aspect-square mx-auto" alt="fire burger illustration " />
                </div>
